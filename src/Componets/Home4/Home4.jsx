          ...
          <div className="w-full justify-start items-center gap-12 grid lg:grid-cols-2 grid-cols-1">
            ...
            <div className="w-full flex-col justify-center lg:items-start items-center gap-10 inline-flex">
              <div className="w-full flex-col justify-center items-start gap-8 flex">
                ...
                <h2 className=" text-lg text-blue-600 font- font-manrope leading-normal text-start ">
              ABOUT US</h2>
                ...
                <div className="w-full lg:justify-center justify-center items-center sm:gap-10 gap-5 inline-flex ">
                  ...
                  <div className="flex-col justify-center items-start inline-flex text-center">
                    <h4 className="text-blue-600  text-4xl font-bold font-manrope leading-normal text-center">52+</h4>
                ...
                <div className="w-full lg:justify-center justify-center items-center sm:gap-10 gap-5 inline-flex text-center">
                  <div className="flex-col justify-start items-start inline-flex text-center">
                    <h3 className="text-blue-600  text-4xl font-bold font-manrope leading-normal text-center">33+</h3>
...
<div className="my-5">
<h6 className="text-blue-600  text-sm font-medium font-manrope leading-normal text-center ">
      WORK-LIFE
      </h6>
